...
def grand_weighted_kernel_type1(geometric_weight, kernel_model):
    """computes the grand weighted kernel of type 1
    ...
    Returns:
        2D array: grand weighted kernel of type 1 (Ni, Ni)
    """
...
def grand_weighted_kernel_type2(
    geometric_weight, spectral_matrix, kernel_model_s, kernel_model_x
):
    """computes the grand weighted kernel of type 2
    ...
    Returns:
        2D array: grand weighted kernel of type 2 (Ni*Nl, Ni*Nl)
    """
    wkernel_type1 = grand_weighted_kernel_type1(geometric_weight, kernel_model_s)
    wkernel_spectral = weighted_spectral_kernel(spectral_matrix, kernel_model_x)
    return jnp.kron(wkernel_type1, wkernel_spectral)


def grand_weighted_kernel_type3(geometric_weight, kernel_model_s, kernel_model_t):
    """computes the grand weighted kernel of type 3
    Args:
        geometric_weight (2D array): geometric weight (Ni, Nj)
        kernel_model_s (2D array): kernel for the model covariances for S(patial) (Nj, Nj)
    ...
    Returns:
        2D array: grand weighted kernel of type 3 (Ni, Ni)
    """
    wkernel_type1 = grand_weighted_kernel_type1(geometric_weight, kernel_model_s)
    return wkernel_type1 * kernel_model_t


def grand_weighted_kernel_type4(
    geometric_weight, spectral_matrix, kernel_model_s, kernel_model_t, kernel_model_x
):
    """computes the grand weighted kernel of type 4
    ...
    Returns:
        2D array: grand weighted kernel of type 4 (Ni*Nl, Ni*Nl)
    """
    wkernel_spectral = weighted_spectral_kernel(spectral_matrix, kernel_model_x)
    kernel_type3 = grand_weighted_kernel_type3(
